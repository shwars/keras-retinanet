...
def _findNode(parent, name, debug_name=None, parse=None, default=None):
...
class GenericVocGenerator(Generator):
    """ Generate data for More Generic Pascal VOC dataset.
    ...
    def __init__(
        ...
        **kwargs
        ...
        """ Initialize a Generic Pascal VOC data generator.

        Args
            base_dir: Directory w.r.t. where the files are to be searched (defaults to the directory containing the csv_data_file).
            classes: Path to the CSV classes file.
        """
        self.data_dir             = data_dir
        self.set_name             = set_name
        self.labels              = dict(enumerate(classes.split(',')))
        ...
        super(GenericVocGenerator, self).__init__(**kwargs)
    ...
    def __parse_annotation(self, element):
        ...
        """
        truncated = _findNode(element, 'truncated', parse=int, default=0)
        difficult = _findNode(element, 'difficult', parse=int, default=0)
